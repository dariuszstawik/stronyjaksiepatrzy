...
<Button path="https://futprints-website.vercel.app/" isExternalLink>Przejdź do strony</Button>
        ...
        <Image className="mt-24 w-full lg:hidden" src="/futprints-mockup.jpg" alt="mockup strony Fundacji Futprints" width={1200} height={800} />
      </div>
      <div className="hidden lg:block lg:absolute lg:top-0 lg:mt-32 transition ease-in-out delay-150 lg:-mr-40 lg:right-0 lg:w-1/2 hover:-translate-x-60">
        <Image className="h-full w-full" src="/futprints-mockup.jpg" alt="mockup strony Fundacji Futprints"  width={1200} height={800} />
      </div>
    </section>
  );
};
