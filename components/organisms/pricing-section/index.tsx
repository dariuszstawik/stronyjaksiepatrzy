        ...
        <div className="flex flex-wrap items-center -mx-3">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-3">
            <div className="pt-12 pb-8 px-8 bg-red-400 rounded-xl lg:text-center">
              <h3 className="mb-6 font-semibold text-red-300">Pro</h3>
              ...
              <ul className="mb-6 text-left">
                ...
                <li className="flex items-center py-4 border-b border-red-400">
                  ...
                  <p className="font-medium text-white">100GB cloud storage</p>
                </li>
                <li className="flex items-center py-4 border-b border-red-400">
                  <svg
                    className="mr-2"
              ...
              <a
                className="block py-4 text-sm text-center text-white font-medium leading-normal bg-blue-400 hover:bg-blue-500 rounded transition duration-200"
                href="#"
              >
                Try it now
              </a>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-3">
            <div className="pt-12 pb-8 px-8 bg-white border rounded-xl lg:text-center">
              <h3 className="mb-6 font-semibold text-gray-500">Premium</h3>
              <div className="flex lg:justify-center mb-8">
